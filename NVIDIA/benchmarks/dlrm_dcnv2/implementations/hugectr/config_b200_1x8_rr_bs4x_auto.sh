#!/bin/bash
# bs=4x with SHARDING_PLAN=auto (vs round_robin). At larger batch the
# auto planner may rebalance differently than at bs=1x.
source $(dirname ${BASH_SOURCE[0]})/config_common.sh

export RUN_SCRIPT="train.py"
export BATCHSIZE=221184
...
export DGXNNODES=1
export DGXNGPU=8
export DGXSYSTEM=b200_1x8_rr_bs4x_auto
