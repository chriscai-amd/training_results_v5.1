#!/bin/bash
# 0.5x batch-size variant of config_b200_1x8_round_robin.sh
# 27648 = 3456 / GPU on 8x B200.
# Used to test whether throughput scales with batch size (= host-bound) or
# stays flat (= GPU-bound).
...
export DGXNNODES=1
export DGXNGPU=8
export DGXSYSTEM=b200_1x8_rr_bs05x
