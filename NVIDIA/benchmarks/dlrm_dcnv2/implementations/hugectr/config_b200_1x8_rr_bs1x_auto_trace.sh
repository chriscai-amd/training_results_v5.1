#!/bin/bash
# bs=1x (MLPerf spec) auto + long training window for nsys tracing
...
export MINIMUM_TRAINING_TIME=3
export DP_SHARDING_THRESHOLD=0.008
export USE_ALGORITHM_SEARCH=false
export MAX_ITER=500000
export DISPLAY_INTERVAL=2000
...
export DGXNNODES=1
export DGXNGPU=8
export DGXSYSTEM=b200_1x8_rr_bs1x_auto_trace
