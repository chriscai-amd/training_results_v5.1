...
template <typename key_type, typename value_type, typename out_value_type>
void static_table<key_type, value_type, out_value_type>::Clear(hipStream_t stream) {
  static_hash_table_.clear(stream);
}

template class static_table<unsigned int, float, float>;
template class static_table<unsigned int, __hip_fp8_e4m3_fnuz, float>;
template class static_table<unsigned int, __hip_fp8_e4m3_fnuz, __hip_fp8_e4m3_fnuz>;
template class static_table<long long, float, float>;
template class static_table<long long, __hip_fp8_e4m3_fnuz, float>;
template class static_table<long long, __hip_fp8_e4m3_fnuz, __hip_fp8_e4m3_fnuz>;
