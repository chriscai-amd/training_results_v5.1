...
#if defined(__NVCC__) || (defined(__clang__) && defined(__CUDA__)) || defined(__HIPCC__)
// HIP under amdclang sets __HIPCC__ during device compilation passes; treat the
// same as CUDA for purposes of __host__/__device__ annotations.
