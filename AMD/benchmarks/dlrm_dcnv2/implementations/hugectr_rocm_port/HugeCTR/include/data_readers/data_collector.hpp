...
// HugeCTR ROCm port: NVTX -> roctx mapping. roctracer/roctx provides
// drop-in replacements for the (small) NVTX subset HugeCTR uses.
#include <roctracer/roctx.h>
#define nvtxRangePushA(...) roctxRangePushA(__VA_ARGS__)
