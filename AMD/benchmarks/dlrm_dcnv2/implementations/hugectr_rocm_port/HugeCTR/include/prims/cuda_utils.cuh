...
// HugeCTR ROCm port: cuml/common/utils.hpp not vendored; the only thing this
// header pulled in was the CUDA_TRY/HOST_DEV_FN style macros which HugeCTR doesn't
// reference from prims/cuda_utils.cuh. Drop the include.
