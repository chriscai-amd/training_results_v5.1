...
std::string BatchNormLayer<T>::get_no_trained_params_in_string() {
  ...
  HCTR_LIB_THROW(hipMemcpy(h_result_running_mean_.data(), d_result_running_mean, n_byte,
                            hipMemcpyDeviceToHost));
  HCTR_LIB_THROW(hipMemcpy(h_result_running_var_.data(), d_result_running_var, n_byte,
                            hipMemcpyDeviceToHost));
