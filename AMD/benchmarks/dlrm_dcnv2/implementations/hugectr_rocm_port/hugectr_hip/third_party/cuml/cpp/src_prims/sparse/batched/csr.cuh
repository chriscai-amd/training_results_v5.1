...
class CSR {
 public:
   ...
   */
  CSR(int m, int n, int nnz, int batch_size, hipblasHandle_t cublasHandle,
  ...
  hipsolverSpHandle_t cusolverSpHandle() const { return m_cusolverSpHandle; }
 ...
 protected:
  ...
  hipsolverSpHandle_t m_cusolverSpHandle;
