...
void convert_parquet_dense_columns(std::vector<T *> &dense_column_data_ptr, const int num_dense,
  ...
  HCTR_LIB_THROW(hipMemcpyAsync(dev_in_column_ptr.data(), dev_ptr_staging, size_of_col_ptrs,
...
size_t convert_parquet_cat_columns(
  ...
  HCTR_LIB_THROW(hipMemcpyAsync(dev_csr_offset_in_buffer.data(), pinned_csr_offset_in_buffer,
                                 size_of_col_ptrs, hipMemcpyHostToDevice, task_stream));
  ...
  HCTR_LIB_THROW(hipMemcpyAsync(dev_csr_value_ptr.data(), pinned_csr_val_out_buffer,
  ...
  HCTR_LIB_THROW(hipMemcpyAsync(dev_csr_row_offset_ptr.data(), pinned_csr_row_offset_buffer,
                                 size_of_csr_pointers, hipMemcpyHostToDevice, task_stream));
  {
