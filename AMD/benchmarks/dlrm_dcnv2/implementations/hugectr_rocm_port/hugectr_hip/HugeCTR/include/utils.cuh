...
// HIP/ROCm: native overloads exist for unsigned long/unsigned long long;
// uint64_t/int64_t alias to those on AMD64 so user-defined overloads conflict.
#ifndef __HIPCC__
...
__inline__ __device__ T warpReduceSum(T val) {
  // HIP/AMD wave64: __shfl_xor_sync requires a 64-bit mask.
