...
struct MultiCrossForwardFunctor {
  ...
  void operator()(hipStream_t stream, hipblasHandle_t cublas_handle,
...
struct MultiCrossForwardFunctorv2 {
  ...
  void operator()(hipStream_t stream, const core23::Tensor& input_tensor,
                  const std::vector<core23::Tensor>& kernel_tensors,
                  const std::vector<core23::Tensor>& bias_tensors,
                  ...
                  const std::vector<CublasAlgo<T>>& xuvb_fprop_algo_, hipblasLtHandle_t = nullptr);
};
...
struct MultiCrossBackwardFunctorv2 {
  ...
  void operator()(hipStream_t dgrad_stream, hipStream_t wgrad_stream, bool async_wgrad,
                  ...
                  hipblasLtHandle_t cublaslt_handle = nullptr);
};
...
class MultiCrossLayer : public TrainableLayer<T> {
 private:
  ...
  hipStream_t wgrad_stream_;
  hipEvent_t event_fork_;
