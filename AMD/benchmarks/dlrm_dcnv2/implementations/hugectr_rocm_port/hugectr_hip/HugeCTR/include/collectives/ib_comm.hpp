...
class IbComm {
 ...
 public:
  ...
  void set_a2a_coll_stream(HierA2ACollHandle coll, hipStream_t stream, size_t device_id);
  ...
  void update_a2a_coll_buf(HierA2ACollHandle coll, const size_t* send_sizes,
                           const size_t* recv_sizes, hipStream_t dep_stream, size_t device_id);
  template <typename T>
  void post_send_command_a2a(HierA2ACollHandle coll, hipStream_t dep_stream, size_t device_id);
  ...
  void set_a2a_coll_stream(HierA2AvCollHandle coll, hipStream_t stream, size_t device_id);
  ...
  template <typename T>
  void post_send_command_a2a(HierA2AvCollHandle coll, hipStream_t dep_stream, size_t device_id);
  template <typename T>
  void post_a2a_send_command(HierA2AvCollHandle coll, hipStream_t dep_stream, size_t device_id);
  void blocking_wait(HierA2AvCollHandle coll, hipStream_t dep_stream, size_t device_id);
  ...
  template <typename T>
  void all_reduce(ARCollHandle coll, hipStream_t stream, size_t device_id);
  template <typename T>
 ...
 private:
  ...
  void all_reduce(ARCollHandle coll, hipStream_t stream, size_t device_id) const;
  template <typename T>
