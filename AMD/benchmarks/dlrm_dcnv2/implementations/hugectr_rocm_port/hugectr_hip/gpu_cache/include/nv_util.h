...
template <>
struct is_fp8<__hip_fp8_e4m3_fnuz> : std::true_type {};

template <>
struct is_fp8<__hip_fp8_e5m2_fnuz> : std::true_type {};
...
inline int get_dev(const void* ptr) {
  ...
  // HIP unifies the field name to `type` regardless of runtime version.
