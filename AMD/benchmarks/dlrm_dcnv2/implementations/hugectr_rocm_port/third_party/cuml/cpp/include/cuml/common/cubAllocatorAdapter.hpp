...
class cachingDeviceAllocator : public deviceAllocator {
 public:
  cachingDeviceAllocator()
    : _allocator(8, 3, hipcub::CachingDeviceAllocator::INVALID_BIN,
                 hipcub::CachingDeviceAllocator::INVALID_SIZE) {}
   ...
   */
  void* allocate(std::size_t n, hipStream_t stream) {
    void* ptr = 0;
   ...
   */
  void deallocate(void* p, std::size_t n, hipStream_t stream) {
    _allocator.DeviceFree(p);
  }

 private:
  hipcub::CachingDeviceAllocator _allocator;
};
