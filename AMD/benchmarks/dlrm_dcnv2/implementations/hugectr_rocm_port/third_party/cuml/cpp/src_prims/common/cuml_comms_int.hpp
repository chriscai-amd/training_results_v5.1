...
class cumlCommunicator {
 public:
   ...
   */
  status_t syncStream(hipStream_t stream) const;
  ...
  void allreduce(const void* sendbuff, void* recvbuff, int count,
                 datatype_t datatype, op_t op, hipStream_t stream) const;
  ...
  /**
     ...
     */
  template <typename T>
  void bcast(T* buff, int count, int root, hipStream_t stream) const {
  ...
  void allgather(const void* sendbuff, void* recvbuff, int sendcount,
                 datatype_t datatype, hipStream_t stream) const;
  ...
  template <typename T>
  void allgatherv(const void* sendbuf, void* recvbuf, const int recvcounts[],
                  const int displs[], hipStream_t stream) const {
